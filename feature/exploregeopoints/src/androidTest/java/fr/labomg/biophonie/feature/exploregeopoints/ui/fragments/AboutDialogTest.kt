package fr.labomg.biophonie.feature.exploregeopoints.ui.fragments
...
import fr.labomg.biophonie.feature.exploregeopoints.AboutDialog
...
class AboutDialogTest {
    ...
    fun user_can_visit_laboMg() {
        launchFragmentInContainer<AboutDialog>()
