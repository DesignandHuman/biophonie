...
class UnexpectedThrowable(override val message: String = "something unexpected happened") :
    Throwable()

class NoConnectionThrowable(override val message: String = "could not connect to server") :
    Throwable()
